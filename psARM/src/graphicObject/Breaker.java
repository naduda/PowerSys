...
public class Breaker extends AShape {
	...
	private final double oneMM = SH_HEIGHT / 18;
	
	private final Rectangle rectB = new Rectangle(0, 5 * oneMM, SH_WIDTH, SH_WIDTH);
	private final Line l1 = new Line(SH_WIDTH/2, 0, SH_WIDTH/2, 5 * oneMM);
	private final Line l2 = new Line(SH_WIDTH/2, 5 * oneMM + SH_WIDTH, SH_WIDTH/2, SH_HEIGHT);
