...
public class TC extends AShape {
	...
	private final double oneMM = SH_WIDTH / 13;
	
	private final double rArc = 1.5 * oneMM;
	
	private final Circle c1 = new Circle(lineWidth, rArc, 0.7 * oneMM);
	private final Circle c2 = new Circle(SH_WIDTH - lineWidth, rArc, 0.7 * oneMM);
