...
public class Scheme3 extends ScrollPane {
...
//	}
//	
//	public Scheme3(String fileName) {
//		this();
//		
//		Object result = null;
//		try {
...
//			Group conteyner = new Scheme3(ToolsPrLib.getFullPath("./schemes/" + schemeName + ".xml")).getRoot();
